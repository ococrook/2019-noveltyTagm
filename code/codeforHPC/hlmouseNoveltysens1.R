...
hlmouseTagmNoveltyparams_beta01 <- tagmMcmcTrain_Nov(object = hyperLOPIT2015,
                                                     fcol = "markers",
                                                     numIter = 15000,
                                                     thin = 10,
                                                     burnin = 5000,
...
save(hlmouseTagmNoveltyparams_beta01, file = "/home/omc25/rds/hpc-work/hlmouseTagmNoveltyparams_beta01.rda")